...
export class AsyncHttpRequest {
  ...
  async AnalyzeEmotions(text: string, __baml_options__?: BamlCallOptions): Promise<HTTPRequest> {
    try {
  ...
  async ExtractResume(resume: string, __baml_options__?: BamlCallOptions): Promise<HTTPRequest> {
    try {
      return await this.runtime.buildRequest(
        'ExtractResume',
        {
