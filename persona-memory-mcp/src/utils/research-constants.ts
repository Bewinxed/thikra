...
export const RESEARCH_CITATIONS = {
  PAD_MODEL: "Russell, J. A., & Mehrabian, A. (1977). Evidence for a three-factor theory of emotions. Journal of research in Personality, 11(3), 273-294.",
  GOTTMAN_RATIO: "Gottman, J. M. (1994). What predicts divorce? The relationship between marital processes and marital outcomes. Hillsdale, NJ: Lawrence Erlbaum Associates.",
  BIG_FIVE: "Costa, P. T., & McCrae, R. R. (1992). Four ways five factors are basic. Personality and individual differences, 13(6), 653-665.",
  EFFECT_SIZES: "Cohen, J. (1988). Statistical power analysis for the behavioral sciences (2nd ed.). Hillsdale, NJ: Lawrence Erlbaum.",
  KNAPP_MODEL: "Knapp, M. L. (1984). Interpersonal communication and human relationships. Boston: Allyn and Bacon.",
} as const;