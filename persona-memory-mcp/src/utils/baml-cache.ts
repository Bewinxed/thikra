...
export class BAMLCache {
   ...
   */
  async call<T>(functionName: string, args: any[], bamlFn: () => Promise<T>): Promise<T> {
   ...
   */
  async callSingle<T>(functionName: string, arg: any, bamlFn: () => Promise<T>): Promise<T> {
